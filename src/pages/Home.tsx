...
const Home: React.FC = () => {
  ...
  return (
    <Layout headerProps={{ onNavigate: (route: string) => navigate(route) }}>
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center min-h-[85vh] w-full text-center px-4 py-20">
        ...
        <Label as="p" className="mb-12 text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed font-light">
          ...
          <strong className="text-foreground font-semibold block mt-2">Teste grátis!</strong>
        </Label>
        ...
        <div className="w-full max-w-6xl">
          <Title variant="h2" className="mb-4 text-foreground font-semibold text-3xl">
